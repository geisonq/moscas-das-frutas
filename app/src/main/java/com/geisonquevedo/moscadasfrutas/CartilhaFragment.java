...
public class CartilhaFragment extends Fragment {
    ...
    public static CartilhaFragment newInstance(String param1, String param2) {
        CartilhaFragment fragment = new CartilhaFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_cartilha, container, false);
